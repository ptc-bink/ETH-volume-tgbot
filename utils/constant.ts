...
export const SOL_ALCHEMY_RPC_ENDPOINT =
  process.env.SOL_ALCHEMY_RPC_ENDPOINT || '';
export const SOLANA_NET_RPC_ENDPOINT =
  process.env.SOLANA_NET_RPC_ENDPOINT || '';
export const ETH_RPC_ENDPOINT = process.env.ETH_RPC_ENDPOINT || '';
export const ETH_SEPOLIA_RPC_ENDPOINT =
  process.env.ETH_SEPOLIA_RPC_ENDPOINT || '';
...
export const BASE_WALLET_PRIVATE_KEY =
